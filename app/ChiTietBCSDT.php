...
class ChiTietBCSDT extends Model
{
    //
    protected $table = "chitietbcsdt";
    protected $primaryKey = ['MaBCSDT', 'MaThuoc'];
    public $incrementing = false;

    public function baocaosudungthuoc()
    {
        return $this->belongsTo('App\BaoCaoSuDungThuoc','MaBCSDT');
    }
