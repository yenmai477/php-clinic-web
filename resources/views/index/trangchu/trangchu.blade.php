...
<div class="row">
  <div class="col-xl-6">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title mb-4">Top 3 thuốc có <b style="color: red">số lượng</b> sử dụng nhiều nhất</h4>
  ...
  <div class="col-xl-6">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title mb-4">Top 3 thuốc có <b style="color: red">số lần</b> sử dụng nhiều nhất</h4>
