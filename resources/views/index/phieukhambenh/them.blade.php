          ...
          <div class="col-md-6">
            <div class="p-l-r-10">
              ...
              <div class="form-group">
                ...
                <select class="selectpicker" data-style="btn-default btn-custom" id="loaibenh" name="loaibenh">
    ...
    <div class="col-sm-12">
      <div class="card-box table-responsive">
        ...
        <div class="p-l-r-10 p-t-10">
          <div class="form-group">
            <button class="ladda-button btn btn-default" data-style="expand-right" @if ($CanhBao !="" ) disabled @endif>Lưu lại
            </button>
          </div>
        </div>
      </div>
