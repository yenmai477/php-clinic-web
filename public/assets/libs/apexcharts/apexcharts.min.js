            ...
            return a(t, [{
                ...
                value: function(t, e) {
                    ...
                    if ("mousemove" === t.type) {
                        ...
                        for (var o = 0; o < a.length; o++) a[o].classList.remove(this.legendInactiveClass)
                }
            }, {
                        ...
                        var r = new P({}),
                            n = function() {
                                ...
                                if (n > a) {
                                    ...
                                    for (var l = 0; l < s.length; l++) n < s[l].breakpoint && (t = M.extendArrayProps(r, s[l].options), t = g.extend(i.config, t), e.overrideResponsiveOptions(t))
                            };
                        if (t) {
                ...
                value: function(t, e) {
                    ...
                    for (var s = a.group({
                        ...
                        for (var y = a.group({
                            ...
                            d = C.y, c = C.x;
                            var M = this.barHelpers.getPathFillColor(t, r, w, f),
        ...
        Pt = function() {
            ...
            return a(t, [{
                ...
                value: function() {
                    ...
                    e.dom.elLegendForeign && e.dom.elLegendForeign.setAttribute("height", s), e.dom.elWrap.style.height = s + "px", p.setAttrs(e.dom.Paper.node, {
                        height: s
